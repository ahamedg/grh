...
class __TwigTemplate_c093b1837ed887ac278b298c0651e64353105ea1e7c5eceb40d50c0a8142a936 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t";
            ...
            if (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["c"], "actif", [], "any", false, false, false, 58), true)) {
                // line 59
                echo "\t\t\t\t\t\t\t\t<i id=\"etatActif\" class=\"far fa-check-circle\" style=\"font-size:20px;color:green\" title=\"Sous-compte actif\"></i>
\t\t\t\t\t\t\t";
            } else {
                // line 61
                echo "\t\t\t\t\t\t\t\t";
                // line 62
                echo "\t\t\t\t\t\t\t\t<i id=\"etatInactif\" class=\"far fa-times-circle\" style=\"font-size:20px;color:red\" title=\"Sous-compte inactif\"></i>
\t\t\t\t\t\t\t";
            }
            // line 64
            echo "\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t<a href=\"";
            // line 66
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("sous_compte_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["c"], "id", [], "any", false, false, false, 66)]), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t\t<i id=\"btnEdit\" title=\"Modifier\" class=\"far fa-edit\" style=\"font-size:16px;\"></i>
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t<a href=\"";
            // line 69
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("sous_compte_new_by_sous_compte", ["id" => twig_get_attribute($this->env, $this->source, $context["c"], "id", [], "any", false, false, false, 69)]), "html", null, true);
            echo "\">
...
\t\t\t\t\t\t<td class=\"text-center\">
\t\t\t\t\t\t\t{% if c.actif==true %}
\t\t\t\t\t\t\t\t<i id=\"etatActif\" class=\"far fa-check-circle\" style=\"font-size:20px;color:green\" title=\"Sous-compte actif\"></i>
\t\t\t\t\t\t\t{% else %}
\t\t\t\t\t\t\t\t{# <i id=\"etatInactif\" class=\"btn-success fas fa-check-circle\" style=\"width: 50%\"></i> #}
\t\t\t\t\t\t\t\t<i id=\"etatInactif\" class=\"far fa-times-circle\" style=\"font-size:20px;color:red\" title=\"Sous-compte inactif\"></i>
\t\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t</td>
\t\t\t\t\t\t<td class=\"text-center\">
