...
class __TwigTemplate_73ad5cc74de50cfbbf5f2858104172b45e9934d71817ca94d0cc8465eaedcd65 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t<th style=\"width: 30%\">States/Région</th>
...
\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["listMapVille"]) || array_key_exists("listMapVille", $context) ? $context["listMapVille"] : (function () { throw new RuntimeError('Variable "listMapVille" does not exist.', 29, $this->source); })()));
