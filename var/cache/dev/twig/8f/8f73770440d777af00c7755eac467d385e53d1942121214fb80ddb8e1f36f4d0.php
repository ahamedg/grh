...
class __TwigTemplate_f235ca43fac1c770eae8c6e0e75e481eaa6c13b0ae66dabf5847638895ff67ab extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["listMapCommune"]) || array_key_exists("listMapCommune", $context) ? $context["listMapCommune"] : (function () { throw new RuntimeError('Variable "listMapCommune" does not exist.', 43, $this->source); })()));
...
\t\t\t\t\t\t\t\t\t\t<td>";
            // line 46
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "libelle", [], "any", false, false, false, 46), "html", null, true);
            echo "</td>
\t\t\t\t\t\t\t\t\t\t<td>";
            // line 47
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "description", [], "any", false, false, false, 47), "html", null, true);
            echo "</td>
\t\t\t\t\t\t\t\t\t\t<td>
