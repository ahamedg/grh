...
class __TwigTemplate_2940770db6f0cc3287123855090928057eb1c4dcdc8fa9092126cdd091c6ce85 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_breadcrumb($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <li class=\"breadcrumb-item active\"> Catégorie service</li>
";
    ...
    public function block_body_inside($context, array $blocks = [])
    {
        ...
        // line 10
        echo "    ";
        $this->loadTemplate("cloud_compte/pills/paramComptePills.html.twig", "cloud_compte/params/cloudCategorieService.html.twig", 10)->display($context);
        // line 11
        echo "    <br/>
    <div class=\"container\">
        <div class=\"row\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["listCloudCategorieService"]) || array_key_exists("listCloudCategorieService", $context) ? $context["listCloudCategorieService"] : (function () { throw new RuntimeError('Variable "listCloudCategorieService" does not exist.', 44, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["cs"]) {
            ...
            echo "</td>
                                    <td>";
            // line 47
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["cs"], "libelle", [], "any", false, false, false, 47), "html", null, true);
            echo "</td>
                                    <td>";
            // line 48
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["cs"], "description", [], "any", false, false, false, 48), "html", null, true);
            echo "</td>
                                    <td>
    ...
    <div class=\"modal fade\" id=\"editCloudCategorieServiceModal\" tabindex=\"-1\" role=\"dialog\"
...
{% endblock %}
{% block  breadcrumb %}
    <li class=\"breadcrumb-item active\"> Catégorie service</li>
{% endblock %}
