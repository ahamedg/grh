 ...
 */
class MapPrefecture extends \App\Entity\MapPrefecture implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\MapPrefecture' . "\0" . 'id', '' . "\0" . 'App\\Entity\\MapPrefecture' . "\0" . 'code', '' . "\0" . 'App\\Entity\\MapPrefecture' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\MapPrefecture' . "\0" . 'description', '' . "\0" . 'App\\Entity\\MapPrefecture' . "\0" . 'states', 'idCompte', 'actif', 'supprimer', 'dateAjout', 'dateEdit', 'idUserAuteur', 'idUserEdit', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MapPrefecture $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCode(string $code): \App\Entity\MapPrefecture
    {
     ...
     * {@inheritDoc}
     */
    public function setLibelle(string $libelle): \App\Entity\MapPrefecture
    {
     ...
     * {@inheritDoc}
     */
    public function setDescription(?string $description): \App\Entity\MapPrefecture
    {
     ...
     * {@inheritDoc}
     */
    public function setStates(?\App\Entity\MapStates $states): \App\Entity\MapPrefecture
    {
