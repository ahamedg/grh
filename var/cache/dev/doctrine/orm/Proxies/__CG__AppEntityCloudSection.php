 ...
 */
class CloudSection extends \App\Entity\CloudSection implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\CloudSection' . "\0" . 'id', '' . "\0" . 'App\\Entity\\CloudSection' . "\0" . 'code', '' . "\0" . 'App\\Entity\\CloudSection' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\CloudSection' . "\0" . 'description', 'idCompte', 'actif', 'supprimer', 'dateAjout', 'dateEdit', 'idUserAuteur', 'idUserEdit', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CloudSection $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCode(string $code): \App\Entity\CloudSection
    {
     ...
     * {@inheritDoc}
     */
    public function setLibelle(string $libelle): \App\Entity\CloudSection
    {
     ...
     * {@inheritDoc}
     */
    public function setDescription(?string $description): \App\Entity\CloudSection
    {
