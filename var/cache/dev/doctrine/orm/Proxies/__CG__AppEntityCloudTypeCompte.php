 ...
 */
class CloudTypeCompte extends \App\Entity\CloudTypeCompte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\CloudTypeCompte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\CloudTypeCompte' . "\0" . 'code', '' . "\0" . 'App\\Entity\\CloudTypeCompte' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\CloudTypeCompte' . "\0" . 'description', 'idCompte', 'actif', 'supprimer', 'dateAjout', 'dateEdit', 'idUserAuteur', 'idUserEdit', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CloudTypeCompte $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCode(string $code): \App\Entity\CloudTypeCompte
    {
     ...
     * {@inheritDoc}
     */
    public function setLibelle(string $libelle): \App\Entity\CloudTypeCompte
    {
     ...
     * {@inheritDoc}
     */
    public function setDescription(?string $description): \App\Entity\CloudTypeCompte
    {
