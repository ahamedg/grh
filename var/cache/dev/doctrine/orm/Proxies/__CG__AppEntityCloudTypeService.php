 ...
 */
class CloudTypeService extends \App\Entity\CloudTypeService implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\CloudTypeService' . "\0" . 'id', '' . "\0" . 'App\\Entity\\CloudTypeService' . "\0" . 'code', '' . "\0" . 'App\\Entity\\CloudTypeService' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\CloudTypeService' . "\0" . 'description', 'idCompte', 'actif', 'supprimer', 'dateAjout', 'dateEdit', 'idUserAuteur', 'idUserEdit', 'version'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CloudTypeService $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCode(string $code): \App\Entity\CloudTypeService
    {
     ...
     * {@inheritDoc}
     */
    public function setLibelle(string $libelle): \App\Entity\CloudTypeService
    {
     ...
     * {@inheritDoc}
     */
    public function setDescription(?string $description): \App\Entity\CloudTypeService
    {
