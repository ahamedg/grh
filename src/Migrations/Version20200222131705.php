 ...
 */
final class Version20200222131705 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE account_action_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE account_module_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE account_profil_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE account_action (id INT NOT NULL, account_module_id INT NOT NULL, code VARCHAR(100) NOT NULL, libelle VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN NOT NULL, date_ajout TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, date_edit TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, id_user_auteur INT NOT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_60F842E18DB86DCA ON account_action (account_module_id)');
        $this->addSql('CREATE TABLE account_module (id INT NOT NULL, code VARCHAR(100) NOT NULL, libelle VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN NOT NULL, date_ajout TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, date_edit TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, id_user_auteur INT NOT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE account_profil (id INT NOT NULL, account_action_id INT NOT NULL, code VARCHAR(100) NOT NULL, libelle VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN NOT NULL, date_ajout TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, date_edit TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, id_user_auteur INT NOT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C1E27CE4BF48286E ON account_profil (account_action_id)');
        $this->addSql('CREATE TABLE account_utilisateur (id INT NOT NULL, code VARCHAR(100) NOT NULL, username VARCHAR(30) NOT NULL, password VARCHAR(255) NOT NULL, lost_password_url VARCHAR(255) DEFAULT NULL, date_lost_password TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, change_password VARCHAR(255) DEFAULT NULL, email_compte VARCHAR(255) NOT NULL, nom_photo_profil VARCHAR(255) DEFAULT NULL, telephone1_utilisateur VARCHAR(255) NOT NULL, telephone2_utilisateur VARCHAR(255) DEFAULT NULL, adresse_utilisateur VARCHAR(255) DEFAULT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN NOT NULL, date_ajout TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, date_edit TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, id_user_auteur INT NOT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE account_action ADD CONSTRAINT FK_60F842E18DB86DCA FOREIGN KEY (account_module_id) REFERENCES account_module (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE account_profil ADD CONSTRAINT FK_C1E27CE4BF48286E FOREIGN KEY (account_action_id) REFERENCES account_action (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE account_profil DROP CONSTRAINT FK_C1E27CE4BF48286E');
        $this->addSql('ALTER TABLE account_action DROP CONSTRAINT FK_60F842E18DB86DCA');
        ...
        $this->addSql('DROP SEQUENCE account_action_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE account_module_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE account_profil_id_seq CASCADE');
        ...
        $this->addSql('DROP TABLE account_action');
        $this->addSql('DROP TABLE account_module');
        $this->addSql('DROP TABLE account_profil');
