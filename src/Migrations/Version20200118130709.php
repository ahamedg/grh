 ...
 */
final class Version20200118130709 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cloud_categorie_service (id INT NOT NULL, code VARCHAR(10) NOT NULL, libelle VARCHAR(30) NOT NULL, description VARCHAR(255) DEFAULT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN DEFAULT NULL, date_ajout VARCHAR(255) DEFAULT NULL, date_edit VARCHAR(255) DEFAULT NULL, id_user_auteur INT DEFAULT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE cloud_famille_compte (id INT NOT NULL, cloud_type_compte_id INT NOT NULL, designation_cloud_famille_compte VARCHAR(30) NOT NULL, description_cloud_famille_compte VARCHAR(255) DEFAULT NULL, code_acces_cloud_famille_compte VARCHAR(50) NOT NULL, cle_acces_cloud_famille_compte VARCHAR(50) NOT NULL, sigle_cloud_famille_compte VARCHAR(15) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_CAC2547A254A5A9E ON cloud_famille_compte (cloud_type_compte_id)');
        $this->addSql('CREATE TABLE cloud_type_compte (id INT NOT NULL, code VARCHAR(10) NOT NULL, libelle VARCHAR(30) NOT NULL, description VARCHAR(255) DEFAULT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN DEFAULT NULL, date_ajout VARCHAR(255) DEFAULT NULL, date_edit VARCHAR(255) DEFAULT NULL, id_user_auteur INT DEFAULT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE cloud_type_service (id INT NOT NULL, code VARCHAR(10) NOT NULL, libelle VARCHAR(30) NOT NULL, description VARCHAR(255) DEFAULT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN DEFAULT NULL, date_ajout VARCHAR(255) DEFAULT NULL, date_edit VARCHAR(255) DEFAULT NULL, id_user_auteur INT DEFAULT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE test (id INT NOT NULL, code VARCHAR(255) NOT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN DEFAULT NULL, date_ajout VARCHAR(255) DEFAULT NULL, date_edit VARCHAR(255) DEFAULT NULL, id_user_auteur INT DEFAULT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE utilisateur (id INT NOT NULL, code VARCHAR(10) NOT NULL, username VARCHAR(30) NOT NULL, password VARCHAR(255) NOT NULL, lost_password_url VARCHAR(255) NOT NULL, date_lost_password TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, change_password VARCHAR(255) DEFAULT NULL, email_compte VARCHAR(255) NOT NULL, nom_photo_profil VARCHAR(255) DEFAULT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN DEFAULT NULL, date_ajout VARCHAR(255) DEFAULT NULL, date_edit VARCHAR(255) DEFAULT NULL, id_user_auteur INT DEFAULT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
