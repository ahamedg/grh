 ...
 */
final class Version20200114122716 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE test (id INT NOT NULL, code VARCHAR(255) NOT NULL, id_compte INT NOT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN NOT NULL, date_ajout TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_edit TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, id_user_auteur INT NOT NULL, id_user_edit INT NOT NULL, version INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE utilisateur (id INT NOT NULL, code VARCHAR(10) NOT NULL, username VARCHAR(20) NOT NULL, password VARCHAR(30) NOT NULL, lost_password_url VARCHAR(50) NOT NULL, date_lost_password TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, change_password VARCHAR(30) DEFAULT NULL, email_compte VARCHAR(50) NOT NULL, nom_photo_profil VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id))');
    }
