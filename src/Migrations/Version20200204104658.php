 ...
 */
final class Version20200204104658 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cloud_famille_compte (id INT NOT NULL, cloud_type_compte_id INT NOT NULL, pays_id INT NOT NULL, states_id INT NOT NULL, ville_id INT NOT NULL, designation_cloud_famille_compte VARCHAR(150) NOT NULL, description_cloud_famille_compte VARCHAR(255) DEFAULT NULL, code_acces_cloud_famille_compte VARCHAR(50) NOT NULL, cle_acces_cloud_famille_compte VARCHAR(50) NOT NULL, sigle_cloud_famille_compte VARCHAR(15) NOT NULL, adresse_cloud_famille_compte VARCHAR(255) DEFAULT NULL, email_cloud_famille_compte VARCHAR(255) DEFAULT NULL, telephone_cloud_famille_compte VARCHAR(255) NOT NULL, code VARCHAR(10) NOT NULL, logo_cloud_famille_compte VARCHAR(255) DEFAULT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN NOT NULL, date_ajout TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, date_edit TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, id_user_auteur INT NOT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT NOT NULL, code VARCHAR(10) NOT NULL, username VARCHAR(30) NOT NULL, password VARCHAR(255) NOT NULL, lost_password_url VARCHAR(255) DEFAULT NULL, date_lost_password TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, change_password VARCHAR(255) DEFAULT NULL, email_compte VARCHAR(255) NOT NULL, nom_photo_profil VARCHAR(255) DEFAULT NULL, telephone1_utilisateur VARCHAR(255) NOT NULL, telephone2_utilisateur VARCHAR(255) DEFAULT NULL, id_compte INT DEFAULT NULL, actif BOOLEAN NOT NULL, supprimer BOOLEAN NOT NULL, date_ajout TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, date_edit TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, id_user_auteur INT NOT NULL, id_user_edit INT DEFAULT NULL, version INT NOT NULL, PRIMARY KEY(id))');
