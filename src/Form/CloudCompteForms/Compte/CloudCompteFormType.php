...
class CloudCompteFormType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('designationCloudCompte', TextType::class, $this->getConfiguration('Nom du sous-compte *', 'Nom du sous-compte...'))
            ...
            ->add('sigleCloudCompte', TextType::class, $this->getConfiguration('Sigle', 'Saisir sigle du sous-compte...', ['required' => false]))
