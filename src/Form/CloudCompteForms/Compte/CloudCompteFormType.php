...
class CloudCompteFormType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('cloudFamilleCompte', EntityType::class, ['class' => CloudFamilleCompte::class, 'choice_label' => 'libelle', 'label'=>'Compte parent *', 'placeholder'=>'Sélectionner un compte parent...'])
           ...
           // ->add(' cloudFamilleCompte', TextareaType::class, $this->getConfiguration('Compte parent', 'Mettre une adresse...', ['required' => false]))
            ...
            ->add('telephone2CloudCompte', TextType::class, $this->getConfiguration('N°Téléphone 2', 'N°Téléphone 2...'))
            ...
            ->add('commune', EntityType::class, ['class' => MapCommune::class, 'choice_label' => 'libelle', 'label'=>'Commune', 'placeholder'=>'Sélectionner une commune...'])
            ...
            ->add('cloudTypeBudget', EntityType::class, ['class' => CloudTypeBudget::class, 'choice_label' => 'libelle', 'label'=>'Type de budget', 'placeholder'=>'Sélectionner un type de budget...'])
            ->add('cloudSection', EntityType::class, ['class' => CloudSection::class, 'choice_label' => 'libelle', 'label'=>'Section', 'placeholder'=>'Sélectionner une section...'])
            ->add('cloudCategorieService', EntityType::class, ['class' => CloudCategorieService::class, 'choice_label' => 'libelle', 'label'=>'Catégorie de service *', 'placeholder'=>'Sélectionner une catégorie de service...'])
            ->add('cloudTypeService', EntityType::class, ['class' => CloudTypeService::class, 'choice_label' => 'libelle', 'label'=>'Type de service *', 'placeholder'=>'Sélectionner un type de service...']);
    }
