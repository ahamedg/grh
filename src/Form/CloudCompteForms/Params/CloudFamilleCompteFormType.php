...
class CloudFamilleCompteFormType extends ApplicationType
{
    ...
    {
        $builder
            ->add('cloudTypeCompte', EntityType::class, ['class' => CloudTypeCompte::class, 'choice_label' => 'libelle', 'placeholder'=>'Type compte *'])
            ...
            ->add('pays', EntityType::class, ['class' => MapPays::class, 'choice_label' => 'nomPays', 'placeholder'=>'Pays *'])

            ->add('states', EntityType::class, ['class' => MapStates::class, 'choice_label' => 'nomStates', 'placeholder'=>'State/Région *'])
            //->add('ville', EntityType::class, ['class' => MapVille::class, 'choice_label' => 'nomVille', 'placeholder'=>'Ville *'])
